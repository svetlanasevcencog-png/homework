...
QUEUE BUILD
1. Query Jira (Atlassian MCP, site legionqaschool / cloudId f72d2b24-8968-4705-8538-069e61d5ed43) with:
...
- Add the `tests-generated` label to the ticket so the next run's queue skips it.
