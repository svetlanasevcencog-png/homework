...
name: triage
model: inherit
description: Diagnoses a red CI run against the repo and classifies the root cause as real app bug vs test issue. Use proactively whenever a CI build or check fails — even if triage isn't explicitly requested.
---
